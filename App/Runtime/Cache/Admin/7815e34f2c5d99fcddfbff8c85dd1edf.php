...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <td height="24" bgcolor="#353c44"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td><div align="right"><span class="STYLE1">
              <a href="<?php echo U('addExtension');?>"><img src="/Public/resources/admin/images/add.gif" width="10" height="10" /> 添加</a>   &nbsp;
              </span>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      ...
      <?php if(is_array($extData["data"])): foreach($extData["data"] as $key=>$ext): ?><tr>
        <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="center"><span class="STYLE19" id="id"><?php echo ($ext["id"]); ?></span></div></td>
        
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><?php echo ($ext["ext_title"]); ?></div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><?php echo ($ext["ext_url"]); ?></div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><?php echo ($ext['flag'] ==1 ? '已结束':'未开始'); ?></div></td>
          <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><?php echo ($ext["ext_number"]); ?></div></td>
          <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><?php echo ($ext["success_number"]); ?></div></td>
          <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><?php echo ($ext["fail_number"]); ?></div></td>
        <td height="20" bgcolor="#FFFFFF">
          <div align="center" class="STYLE21">

          <a class="delExtension"> <img src="/Public/resources/admin/images/del.gif" width="10" height="10" />删除</a>  | <a href="<?php echo U('updExtension',['ext_id'=>$ext['id']]);?>">修改</a>| <a class="start_extension">开始推广</a></div></td>

...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td>
      ...
      <tr>
        <input type="hidden" id="role_id" value="<?php echo (session('roleId')); ?>">
          ...
          $.ajax({
              ...
              success:function (msg) {
                   if(msg.status ==200){
                      ...
                      //自定义function 用于跳转
//                      setTimeout( 'window.location.href="<?php echo U('redirectUrl');?>"',3000);
                     

                       setTimeout( function () {
//                           console.log(msg.role_id);
//                           window.location.href="<?php echo U('distribute',array('roleId'=>"+msg.role_id+"));?>";
window.location.href="/index.php/Admin/Role/distribute/role_id/"+msg.role_id;
                       },3000);
                  }else if(msg.status ==202){
                      layer.msg(msg.message);
//                      setTimeout('window.location.href ="<?php echo U('showlist');?>",2000);
                       setTimeout( function () {
                           window.location.href="<?php echo U('redirectUrl');?>";
                       },3000);
                   }
              }
          })

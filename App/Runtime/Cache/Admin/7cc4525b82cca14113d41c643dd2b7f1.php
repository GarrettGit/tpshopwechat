          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1"> 管理员管理 -> 添加管理员</span></td>
              </tr>
            </table></td>
  ...
  <tr>
    <td>
      ...
      <tr>
        ...
        <input type="text" name="mg_name" id="mg_name"/>
        </div>
        </td>
      </tr><tr>
        <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="right"><span class="STYLE19">管理员密码：</span></div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="left">
        <input type="password" name="mg_pwd" id="mg_pwd"/>
        </div>
        </td>
      </tr><tr>
        <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="right"><span class="STYLE19">确认密码：</span></div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="left">
        <input type="password" name="mg_passwd" id="mg_passwd"/>
        </div>
        </td>
      </tr>
        <tr>
        <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="right"><span class="STYLE19">职位：</span></div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="left">
        <select name="role_id" id="role_id" >
          <?php if(is_array($roleInfo)): foreach($roleInfo as $key=>$role): ?><option value="<?php echo ($role["role_id"]); ?>" ><?php echo ($role["role_name"]); ?></option><?php endforeach; endif; ?>
        </select>
        </div>
        </td>
      </tr>
      ...
      <tr>
        ...
        <input type="button" value="添加管理员" id="man" />
        </td>
      </tr>
    </table>
    </form>
          ...
          $.ajax({
              ...
              success:function (msg) {
                   if(msg.status ==200){
                      ...
                      layer.msg(msg.message);
                      setTimeout('window.location.href ="<?php echo U('addManager');?>"',2000);
                  }
              }
          })
      })

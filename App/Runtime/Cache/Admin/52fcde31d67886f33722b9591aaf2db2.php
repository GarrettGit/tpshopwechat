          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1"> 会员级别管理 -> 修改会员级别</span></td>
              </tr>
            </table></td>
            <td><div align="right"><span class="STYLE1">
            <a href="<?php echo U('memberList');?>">返回</a>   &nbsp; </span>
    ...
    <td>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" id="general-tab-show" >
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE6">
          <input type="hidden" value="<?php echo ($memberInfo["id"]); ?>" name='id'>
          <div align="right">
          <span class="STYLE19">会员名称：</span></div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="left">
        <input type="text" name="level_name"   value="<?php echo ($memberInfo["level_name"]); ?>"/>
        </div></td>
        </tr>
        <tr>
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="left">
        <input type="text" name="level_rate"  value="<?php echo ($memberInfo["level_rate"]); ?>"/>
        <span style="color: red;">折扣率:100=10折 98=9.8折 90=9折</span></div></td></tr>
        <tr>
        <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="right">
          <span class="STYLE19">积分下限：</span></div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="left">
        <input type="text" name="jifen_bottom" value="<?php echo ($memberInfo["jifen_bottom"]); ?>"/><span style="color: red;">不低于0分</span>
        </div></td>
      </tr>
        <tr>
        <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="right">
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="left">
        <input type="text" name="jifen_top" value="<?php echo ($memberInfo["jifen_top"]); ?>"/>
        </div></td>
      </tr>
    </table>
      ...
      <tr>
        ...
        <input type="submit" value="修改级别" id="auth" />
        </td>
      </tr>
    </table>
    </form>
          ...
          $.ajax({
              ...
              success:function (msg) {
                if(msg.status ==200){
                     ...
                     layer.msg(msg.message);
                     setTimeout('window.location.href ="<?php echo U('addAuth');?>"',2000);
                 }
              }
          })
      })

  ...
  <tr>
    <td>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" id="general-tab-show" >
        <tr>
          <input type="hidden" name="auth_id" value="<?php echo ($authInfo["auth_id"]); ?>" id='auth_id'>
        <td height="20" bgcolor="#FFFFFF" class="STYLE6">
          <div align="right">
          <span class="STYLE19">权限名称：</span></div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="left">
        <input type="text" name="role_name" id="auth_name"  value="<?php echo ($authInfo["auth_name"]); ?>"/>
        </div></td>
        </tr>
      <tr>
        <td height="20" bgcolor="#FFFFFF" class="STYLE6">
        ...
        <select name="auth_pid" id="auth_pid">
          <option>上级名称</option>
          <?php if(is_array($allAuth)): foreach($allAuth as $key=>$v): if($authInfo[auth_pid] == $v['auth_id'] ): ?><option value="<?php echo ($v["auth_id"]); ?>" selected ><?php echo ($v["auth_name"]); ?></option>
             <?php else: ?>
                 <option value="<?php echo ($v["auth_id"]); ?>" ><?php echo ($v["auth_name"]); ?></option><?php endif; ?>><?php endforeach; endif; ?>
        </select>
        </div>
        </td>
      </tr>
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="left">
        <input type="text" name="auth_c" id="auth_c" value="<?php echo ($authInfo["auth_c"]); ?>"/>
        </div></td></tr>
        <tr>
        <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="right">
          <span class="STYLE19">操作方法：</span></div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="left">
        <input type="text" name="auth_a" id="auth_a" value="<?php echo ($authInfo["auth_a"]); ?>"/>
        </div></td
      </tr>
    </table>
      ...
      <tr>
        ...
        <input type="button" value="修改权限" id="auth" />
        </td>
      </tr>
    </table>
    </form>

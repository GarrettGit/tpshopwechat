  ...
  <tr>
    <td>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" id="general-tab-show" >
        ...
        <input type="text" name="ext_title"  />
      ...
      <tr>
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19">
         <input type="text" name="ext_url" i />
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="left">
        <input type="text" name="ext_number"  />
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="left">
          <textarea style="width:620px; height:200px;"  name="ext_introduce"></textarea>

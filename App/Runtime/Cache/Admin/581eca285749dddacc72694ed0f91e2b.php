  ...
  <tr>
    <td>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" id="general-tab-show" >
        ...
        <input type="text" name="ext_title" id="auth_name" />
        </div></td>
        </tr>
      <tr>
        <td height="20" bgcolor="#FFFFFF" class="STYLE6">
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19">
         <input type="text" name="ext_url" id="auth_name" />
        </div>
        </td>
      </tr>
        <tr>
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="left">
        <input type="text" name="ext_number" id="auth_c" />
        </div></td></tr>
        <tr>
        <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="right">
          <span class="STYLE19">推广内容：</span></div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="left">
          <textarea style="width:620px; height:200px;" id="ext_introduce" name="ext_introduce"></textarea>
        </div></td>
      </tr>
    </table>

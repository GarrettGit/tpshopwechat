...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      ...
      <?php if(is_array($typeInfo)): foreach($typeInfo as $key=>$type): ?><tr>
        <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="center"><span class="STYLE19" id="id"><?php echo ($type["type_id"]); ?></span></div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><?php echo ($type["type_name"]); ?></div>
        </td>
           <td height="20" bgcolor="#FFFFFF">
        <div align="center" class="STYLE21">
<a href="<?php echo U('Attribute/showlist',[type_id=>$type['type_id']]);?>">  类型属性  |
          <a  href="<?php echo U('deltype',[type_id=>$type['type_id']]);?>"> 删除</a>  | <a href="<?php echo U('updType',[type_id=>$type['type_id']]);?>">修改</a></div></td>

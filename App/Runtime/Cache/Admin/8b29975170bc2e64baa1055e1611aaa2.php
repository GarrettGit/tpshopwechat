    ...
    <div class="topnav">
        <div class="topnav_bd w1210 bc">
            ...
            <div class="topnav_right fr">
                <ul>
                    <li>
                      <?php if($_SESSION['userName']== '' ): ?>[<a href="<?php echo U('Home/User/login');?>">登录</a>]
                      <?php else: ?>
                        您好 <?php echo (session('userName')); ?>，欢迎来到京西！
                       [<a href="<?php echo U('Home/User/logout');?>">退出登录</a>]<?php endif; ?>
                        [<a href="<?php echo U('Home/User/register');?>">免费注册</a>] </li>
                    <li class="line">|</li>
                    <li><a href="<?php echo U('Home/order/showlist');?>">我的订单</a></li>
                    <li class="line">|</li>
                    <li>客户服务</li>
	...
	<div class="goods_content fl mt10 ml10">
		...
		<div class="summary">
			...
			<div class="preview fl">
				<div class="midpic">
					<a href="<?php echo ($goodsInfo["pics"]["0"]["pics_big"]); ?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
						<img src="<?php echo ($goodsInfo["pics"]["0"]["pics_mid"]); ?>" alt="" />               <!-- 第一幅图片的中图 -->
					</a>
				</div>
				...
				<div class="smallpic">
					...
					<div class="smallpic_wrap">
						<ul>
							<?php if(is_array($goodsInfo['pics'])): foreach($goodsInfo['pics'] as $k=>$pics): ?><li class="cur">
								<?php if(($k) == "0"): ?><a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?php echo ($pics["pics_mid"]); ?>',largeimage: '<?php echo ($pics["pics_big"]); ?>'}"><img src="<?php echo ($pics["pics_sma"]); ?>"></a>
							
								<?php else: ?>
							<li>
								<a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?php echo ($pics["pics_mid"]); ?>',largeimage: '<?php echo ($pics["pics_big"]); ?>'}"><img src="<?php echo ($pics["pics_sma"]); ?>"></a><?php endif; endforeach; endif; ?>
			...
			<div class="goodsinfo fl ml10">
				<ul>
					<li><span>商品编号： </span>tpshop<?php echo ($goodsInfo["goodsInfo"]["goods_id"]); ?></li>
					<li class="market_price"><span>定价：</span><em>￥<?php echo ($goodsInfo["goodsInfo"]["goods_price"]); ?></em></li>
					<li class="shop_price"><span>会员价：</span> ￥<strong id="memberPrice"><?php echo ($goodsInfo["memberPrice"]); ?></strong> <a href="">(降价通知)</a></li>
					<li><span>上架时间：</span><?php echo (date('Y-m-d',$goodsInfo["goodsInfo"]["upd_time"])); ?></li>
					<li class="star"><span>商品评分：</span> <strong></strong><a href="">(已有21人评价)</a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
				</ul>
				<form  class="choose">
					<ul>
						<?php if(is_array($attrInfo['many'])): foreach($attrInfo['many'] as $key=>$attr): ?><li class="product">
							<dl>
								<dt><?php echo ($attr["attr_name"]); ?>：</dt>
								<dd>
									<?php if(is_array($attr['values'])): foreach($attr['values'] as $k=>$v): if(($k) == "0"): ?><a class="selected" href="javascript:"><?php echo ($v); ?> <input type="radio" name="color" value="<?php echo ($v); ?>" checked="checked" /><?php else: ?>
									<a href="javascript:"> <?php echo ($v); ?><input type="radio" name="color" value="<?php echo ($v); ?>"  /></a>
						...
						<li>
							<dl>
								<dt>库存：</dt>
								<dd>
									<?php echo ($goodsInfo["goodsInfo"]["goods_number"]); ?>
								</dd>
								<dt>购买数量：</dt>
								<dd>
									<a href="javascript:;" id="reduce_num"></a>
									<input type="text" name="amount" value="1" class="amount" id="goods_num"/>
						...
						<li>
							<dl>
								<dt>&nbsp;</dt>
								<dd>
									<input type="button" value="" class="add_btn"   id="add_btn" onclick="add_cart(<?php echo ($goodsInfo["goodsInfo"]["goods_id"]); ?>)"/>
								</dd>
							</dl>
						</li>

					</ul>
                    <input type="hidden" id="goods_id" value="<?php echo ($goodsInfo["goodsInfo"]["goods_id"]); ?>">
				</form>
			</div>
			<!-- 商品基本信息区域 end -->
		</div>
		...
		<div class="detail">
			...
			<div class="detail_bd">
				...
				<div class="introduce detail_div none">
					<div class="attr mt15">
						<ul>
							<?php if(is_array($attrInfo['only'])): foreach($attrInfo['only'] as $key=>$only): ?><li><span><?php echo ($only["attr_name"]); ?>：</span><?php echo ($only["attr_value"]); ?></li><?php endforeach; endif; ?>
						</ul>
					</div>

					<div class="desc mt10">
						<!-- 此处的内容 一般是通过在线编辑器添加保存到数据库，然后直接从数据库中读出 -->
						<img src="/Public/resources/home/images/desc1.jpg" alt="" />
						<p style="height:10px;"></p>
						<img src="/Public/resources/home/images/desc2.jpg" alt="" />
						<p style="height:10px;"></p>
						<img src="/Public/resources/home/images/desc3.jpg" alt="" />
						<p style="height:10px;"></p>
						<img src="/Public/resources/home/images/desc4.jpg" alt="" />
						<p style="height:10px;"></p>
						<img src="/Public/resources/home/images/desc5.jpg" alt="" />
						<p style="height:10px;"></p>
						<img src="/Public/resources/home/images/desc6.jpg" alt="" />
						<p style="height:10px;"></p>
						<img src="/Public/resources/home/images/desc7.jpg" alt="" />
						<p style="height:10px;"></p>
						<img src="/Public/resources/home/images/desc8.jpg" alt="" />
						<p style="height:10px;"></p>
						<img src="/Public/resources/home/images/desc9.jpg" alt="" />
					</div>
				</div>
				<!-- 商品介绍 end -->
				...
				<div class="comment detail_div mt10">
					...
					<div class="comment_items mt10">
						<div class="user_pic">
							<dl>
								<dt><a href=""><img src="/Public/resources/home/images/user2.jpg" alt="" /></a></dt>
								<dd><a href="">小宝贝</a></dd>
							</dl>
						</div>
						<div class="item">
					...
					<div class="comment_items mt10">
						<div class="user_pic">
							<dl>
								<dt><a href=""><img src="/Public/resources/home/images/user3.jpg" alt="" /></a></dt>
								<dd><a href="">天使</a></dd>
							</dl>
						</div>
						<div class="item">
...
<div class="buy_blank" id="cartBox" style="display:none;z-index:99;">
    <h4>
        <span><a href="javascript:;" onclick="hideElement('cartBox')"><img src="/Public/resources/home/images/close.jpg" title="点击关闭"/></a></span>
        该商品已成功添加到购物车
    </h4>
...
/*购物车弹出框*/
.orange{color: #CC0000;}
a.bt_orange:link,a.bt_orange:visited{color:#FFFFFF;width:107px; height:27px; line-height:27px;background:url(/Public/resources/home/images/chakanBtn.jpg) no-repeat; text-align:center; font-weight:bold;cursor:pointer; display:block; _display:inline; float:left; margin-left:60px;}
a.bt_blue:link,a.bt_blue:visited{color:#FFFFFF;width:107px; height:27px; line-height:27px;background:url(/Public/resources/home/images/tiaoxuannBtn.jpg) no-repeat; text-align:center; font-weight:bold;cursor:pointer;display:block;_display:inline; float:right; margin-right:60px;}
...
.buy_blank h4{ border-bottom:2px solid #D0D0D0; font-weight:normal; height:30px; line-height:30px;background:url(/Public/resources/home/images/buyicon.jpg) no-repeat 10px center; text-indent:28px; margin-bottom:10px; padding-left:20px;}
...
//获取会员价格
    ...
    $.ajax({
        url:"http://www.tpshop.com/index.php/Home/goods/getMemberPrice'",
        data:{'goods_id':goods_id},
        dataType:'json',
        type:'post',
        success:function (msg) {
            if(msg.status == 200){
              $('#memberPrice').html(msg.memberPrice);
            }
        }
    })

        ...
        <div class="main-page">
            <div class="tables">
                ...
                <div class="table-responsive bs-example widget-shadow">
                    <h4>菜单管理:</h4>
                    <div style="float:right"><button id="creatrMenu">生成菜单</button><button id="delMenu">删除菜单</button></div>
...
//    生成菜单
  $('#creatrMenu').click(function(){
//      http://www.ihelp365.com
      $.get('/index.php/WeChat/wechatApi/CustomizeMenu','',function(msg){
          if(msg.status == 200){
...
//      http://www.ihelp365.com
        $.get('/index.php/WeChat/wechatApi/delMenu','',function(msg){
            if(msg.status == 200){
                layer.msg(msg.message);
            }else if (msg.status == 202){
                layer.msg(msg.message);
...
//    <a href="http://www.ihelp365.com/index.php/WeChat/wechatApi/CustomizeMenu">生成菜单<a>
</script>
<!--scrolling js-->

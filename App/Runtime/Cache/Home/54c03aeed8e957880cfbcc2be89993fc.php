        ...
        <?php else: ?>
            ...
            <div class="navitems fl">
                <ul class="fl">
                    ...
                    <li><a href="<?php echo U('Seckill/SeckillList');?>">秒杀</a></li>
                    <li><a href="">积分商城</a></li>
                    <li><a href="">夺宝奇兵</a></li>
                </ul>
		...
		<div class="summary">
			...
			<div class="goodsinfo fl ml10">
				<ul>
					...
					<li class="shop_price"><span>会员价：</span> <strong>￥<?php echo ($goodsInfo["memberPrice"]); ?></strong> <a href="">(降价通知)</a></li>
					...
					<ul>
						...
						<li>
							<dl>
								<dt>&nbsp;</dt>
								<dd>
									<input type="button" value="" class="add_btn"   id="seckill"/>
								</dd>
							</dl>
						</li>
...
$(function () {
    ...
    $('#seckill').click(function () {
        var goods_id = <?php echo ($goodsInfo["goodsInfo"]["goods_id"]); ?>;
        console.log(goods_id);
        $.ajax({
            url:'/index.php/Home/Seckill/seckillGoods',
            ...
            success:function(msg){
                ...
                if(msg.status ==202){
                    ...
                    //自定义function 用于跳转
                    setTimeout( 'window.location.href="/index.php/Home/User/login"',3000);
                }else if (msg.status ==205){
                    layer.msg(msg.message);

					...
					<ul>
						...
						<li>
							<dl>
								<dt>库存：</dt>
								<dd>
									<?php echo ($seckillInfo["goods_num"]); ?>
								</dd>
								<dt>购买数量：</dt>
								<dd>
                                    <b>1</b></a>
						...
						<li><span id="timebox" style="width: 200px;color: red;font-size: 18px;"><?php echo ($seckillInfo["count_down"]); ?></span></li>
						<li>
							<dl>
								<dt>&nbsp;</dt>
								<dd>
        ...
        $.ajax({
            ...
            success:function(msg){
                if(msg.status ==202){
                    ...
                    layer.msg(msg.message)
                    $.post("<?php echo U('Shop/GoodsOrder');?>",{'seckill_id':msg.seckill_id} );
                }
...
//秒杀倒计时
    ...
    if (timestamp><?php echo ($seckillInfo["etime"]); ?>){
        oTimebox.css('color',"#BEBEBE").text("00天00时00分00秒");
    }else{

...
<body>
	...
	<div class="mycart w990 mt10 bc">
		...
		<table>
			...
			<tbody>
			<?php if(is_array($cartInfo)): foreach($cartInfo as $key=>$info): ?><tr>
					<td class="col1"><a href=""><img src="<?php echo ($info["logo"]); ?>" alt="" /></a>  <strong><a href=""><?php echo ($info["goods_name"]); ?></a></strong></td>
					
					<td class="col3">￥<span><?php echo ($info["goods_price"]); ?></span></td>
					<td class="col4"> 
						<a href="javascript:;" class="reduce_num" onclick="modify_number('red',<?php echo ($info["goods_id"]); ?>)"></a>
						<input type="text" name="amount" value="<?php echo ($info["goods_buy_number"]); ?>" class="amount" id="goods_number_<?php echo ($info["goods_id"]); ?>" onchange="modify_number('mod',<?php echo ($info["goods_id"]); ?>)"/>
						<a href="javascript:;" class="add_num" onclick="modify_number('add',<?php echo ($info["goods_id"]); ?>)"></a>
					</td>
					<td class="col5">￥<span id="goods_xiaoji_<?php echo ($info["goods_id"]); ?>"><?php echo ($info["goods_total_price"]); ?></span></td>
					<td class="col6"><a href=" javascript:if(confirm('确定要删除该商品吗?')){del_goods(<?php echo ($info["goods_id"]); ?>)}">删除</a></td>
				</tr><?php endforeach; endif; ?>
				<!--<tr>-->
					<!--<td class="col1"><a href=""><img src="/Public/resources/home/images/cart_goods2.jpg" alt="" /></a> <strong><a href="">九牧王王正品新款时尚休闲中长款茄克EK01357200</a></strong></td>-->
				...
				<!--</tr>-->
				<!--<tr>-->
					<!--<td class="col1"><a href=""><img src="/Public/resources/home/images/cart_goods3.jpg" alt="" /></a> <strong><a href="">【1111购物狂欢节】捷王纯手工缝制休闲男鞋大头皮鞋 头层牛</a></strong></td>-->
		...
		<div class="cart_btn w990 bc mt10">
			...
			<a href="<?php echo U('Shop/goodsOrder');?>" class="checkout">结 算</a>
		</div>
	</div>
<div style="clear: both"></div>
	<!-- 主体部分 end -->

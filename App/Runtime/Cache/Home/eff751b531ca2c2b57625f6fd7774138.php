...
<div class="list w1210 bc mt10">
	...
	<div class="list_bd fl ml10 mt10">
		...
		<div class="goodslist mt10">
			<ul>
				<?php if(is_array($goodsInfo['list'])): foreach($goodsInfo['list'] as $key=>$v): ?><li>
					<dl>
						<dt><a href="<?php echo U('detail',['goods_id'=>$v['goods_id']]);?>"><img src="<?php echo ($v["goods_small_logo"]); ?>" alt="" /></a></dt>
						
						<dd><a href=""><?php echo ($v["goods_name"]); ?></a></dt>
						<dd><strong >市场价格:</strong class="market_price"><em><strong>￥<?php echo ($v["goods_price"]); ?></strong></em></dt>
						<dd><strong>商城促销价:</strong><strong>￥<?php echo ($v["goods_members_price"]); ?></strong></dt>

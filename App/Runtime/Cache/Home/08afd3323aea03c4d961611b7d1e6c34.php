...
<div class="login w990 bc mt10 regist">
	...
	<div class="login_bd">
			...
			<form action="" method="post">
				<ul>
					...
					<li>
						...
						<p> <span>请再次输入密码</p>
						<span style="color:red;"><?php echo ($errorinfo["pwd"]); ?></span>
					</li>
					<li class="checkcode">
						<label for="">验证码：</label>
						<input type="text"  name="checkCode"  id="checkCode"/>
						<img src="<?php echo U('Admin/manager/verifyImg');?>" alt="看不清？点击换一张"  style="vertical-align: middle" id='verifyImg'/>
		...
		<div class="mobile fl">
			<h3>手机快速注册</h3>			
			<p>
			<a href="<?php echo U('user/tel_register');?>" class="reg_btn">手机快速登录 >></a></p>
		</div>
...
$(function () {
    $('#verifyImg').click(function () {
        var src="<?php echo U('Admin/manager/verifyImg');?>";
    ...
    $('#checkCode').blur(function () {
        ...
        $.ajax({
            url:"<?php echo U('Admin/manager/checkVerifyCode');?>",
            type:'post',
            ...
            success:function(msg) {
                if(msg.status == 200){
                    ...
                    $('#verifyImg').attr('src',"<?php echo U('Admin/manager/verifyImg');?>");
                }
            }

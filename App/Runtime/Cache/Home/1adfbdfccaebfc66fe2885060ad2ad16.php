                ...
                <ul>
                    <li>
                      [<a href="/index.php/Home/User/login.html">登录</a>]
                                              [<a href="/index.php/Home/User/register.html">免费注册</a>] </li>
                    <li class="line">|</li>
                    <li><a href="/index.php/Home/order/showlist.html">我的订单</a></li>
                    <li class="line">|</li>
                    <li>客户服务</li>
    ...
    <div class="header w1210 bc mt15">
        ...
        <div class="logo w1210">
            ...
            <div class="user fl">
                <dl>
                    <dt>
                        <em></em>
                        <a href="/index.php/Admin/user/center.html">用户中心</a>
                        <b></b>
                    </dt>
                    <dd>
                        <div class="prompt">
            ...
            <div class="cart fl">
                <dl>
                    <dt>
                        <a href="/index.php/Admin/shop/viewCart.html">去购物车结算</a>
                        <b></b>
                    </dt>
                    <dd>
                        <div class="prompt">
        ...
        <div class="nav w1210 bc mt10">
            <!--  商品分类部分 start-->
                ...
                <div class="cat_bd none"> <!--非首页，需要设置none类-->
                    <div class="cat item1">
                        <h3><a href="">图像、音像、数字商品</a> <b></b></h3>
                        <div class="cat_detail">
                            <dl class="dl_1st">
	...
	<!--  商品分类部分 end-->
            ...
            <div class="navitems fl">
                <ul class="fl">
                    ...
                    <li><a href="">手机频道</a></li>
                    <li><a href="">家用电器</a></li>
                    <li><a href="/index.php/Admin/Goods/showlist.html">品牌大全</a></li>
                    <li><a href="">团购</a></li>
                    <li><a href="">积分商城</a></li>
                    <li><a href="">夺宝奇兵</a></li>
                </ul>
	...
	<div class="goods_content fl mt10 ml10">
		...
		<div class="summary">
			...
			<div class="preview fl">
				<div class="midpic">
					<a href="/Public/upload/pics/2017-07-17/big596ca06ce8c2a.jpg" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
						<img src="/Public/upload/pics/2017-07-17/mid596ca06ce8c2a.jpg" alt="" />               <!-- 第一幅图片的中图 -->
					</a>
				</div>
				...
				<div class="smallpic">
					...
					<div class="smallpic_wrap">
						<ul>
							<li class="cur">
								<a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '/Public/upload/pics/2017-07-17/mid596ca06ce8c2a.jpg',largeimage: '/Public/upload/pics/2017-07-17/big596ca06ce8c2a.jpg'}"><img src="/Public/upload/pics/2017-07-17/sma596ca06ce8c2a.jpg"></a>
							
								<li class="cur">
															<li>
								<a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '/Public/upload/pics/2017-07-17/mid596ca06ce9bbb.jpg',largeimage: '/Public/upload/pics/2017-07-17/big596ca06ce9bbb.jpg'}"><img src="/Public/upload/pics/2017-07-17/sma596ca06ce9bbb.jpg"></a>							
						</ul>
					</div>
			...
			<div class="goodsinfo fl ml10">
				<ul>
					<li><span>商品编号： </span>tpshop58</li>
					<li class="market_price"><span>定价：</span><em>￥1000.00</em></li>
					<li class="shop_price"><span>会员价：</span> ￥<strong id="memberPrice">990.00</strong> <a href="">(降价通知)</a></li>
					<li><span>上架时间：</span>2017-07-17</li>
					...
					<ul>
						<li class="product">
							<dl>
								<dt>颜色：</dt>
								<dd>
									<a class="selected" href="javascript:">土豪金 <input type="radio" name="color" value="土豪金" checked="checked" />									<a href="javascript:"> 星空灰<input type="radio" name="color" value="星空灰"  /></a>
									</a>								</dd>
							</dl>
						</li><li class="product">
							<dl>
								<dt>cpu：</dt>
								<dd>
									<a class="selected" href="javascript:">高通320 <input type="radio" name="color" value="高通320" checked="checked" />									<a href="javascript:"> 高通618<input type="radio" name="color" value="高通618"  /></a>
									</a>								</dd>
							</dl>
						</li>						<li>
							<dl>
						...
						<li>
							<dl>
								<dt>&nbsp;</dt>
								<dd>
									<input type="button" value="" class="add_btn"   id="add_btn" onclick="add_cart(58)"/>
								</dd>
							</dl>
						</li>

					</ul>
                    <input type="hidden" id="goods_id" value="58">
				</form>
			</div>
			<!-- 商品基本信息区域 end -->
		</div>
		...
		<div class="detail">
			...
			<div class="detail_bd">
				...
				<div class="introduce detail_div none">
					<div class="attr mt15">
						<ul>
							<li><span>尺寸：</span>5.7</li><li><span>网络模式：</span>三网通</li>						</ul>
					</div>
...
<div class="buy_blank" id="cartBox" style="display:none;z-index:99;">
    ...
    <p>
        <a href="/index.php/Admin/Shop/viewCart.html" onclick="javascript:hideElement('cartBox')" class="bt_orange" target="_blank"></a>

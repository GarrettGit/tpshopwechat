	...
	<div class="main w1210 bc mt10">
		...
		<div class="content fl ml10">
			...
			<div class="order_bd mt10">
				<?php if(is_array($orderData)): foreach($orderData as $key=>$order): ?><table class="orders">
					<tbody>
						...
						<tr>
							...
							<td colspan="2"><?php echo (date("Y-m-d H:i:s",$order["add_time"])); ?>&nbsp;&nbsp;<?php echo ((isset($order["order_pay"]) && ($order["order_pay"] !== ""))?($order["order_pay"]):''); ?>支付:￥<?php echo ($order["order_price"]); ?>&nbsp;&nbsp;<?php echo ($order["order_status"]); ?> <a href="/index.php/Home/Order/OrderDetail/order_id/<?php echo ($order["order_id"]); ?>">查看</a> | <a href="">删除</a></td>
						</tr>
					</tbody> 
				</table>

...
<div class="login w990 bc mt10">
	...
	<div class="login_bd">
			...
			<form action="" method="post">
				<ul>
					...
					<li>
						...
						<a href="<?php echo U('user/getBackPwd');?>">忘记密码?</a>
					</li>
					<!--<li class="checkcode">-->
						<!--<label for="">验证码：</label>-->
						<!--<input type="text"  name="checkcode" />-->
						<!--<img src="/Public/resources/home/images/checkcode1.jpg" alt="" />-->
						<!--<span>看不清？<a href="">换一张</a></span>-->
					<!--</li>-->
					<li style="color: red;padding-left: 60px;font-size: 14px">
		...
		<div class="guide fl">
			...
			<p><a href="<?php echo U('user/tel_register');?>" class="reg_btn">手机快速登录 >></a></p>
		</div>
...
{
childWindow = window.open("/index.php/home/User/QQLogin","TencentLogin","width=450,height=320,menubar=0,scrollbars=1, resizable=1,status=1,titlebar=0,toolbar=0,location=1");
}
</script>
